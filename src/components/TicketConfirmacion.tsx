...
const styles = StyleSheet.create({
  ...
  ticketVip: { borderColor: '#f0b429', backgroundColor: '#fffaf0' },
  sello: {
    alignSelf: 'center',
    fontSize: 12,
    fontWeight: '800',
  ...
  subtitulo: { fontSize: 14, color: '#7a6f96', textAlign: 'center', marginTop: 4, marginBottom: 16 },
  linea: { borderBottomWidth: 1, borderColor: '#e6ddf7', borderStyle: 'dashed', marginVertical: 12 },
  fila: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 8 },
  filaEtiqueta: { fontSize: 13, color: '#7a6f96' },
  filaValor: { fontSize: 14, fontWeight: '600', color: '#2d1b4e', maxWidth: '65%', textAlign: 'right' },
  codigo: { textAlign: 'center', fontSize: 20, fontWeight: '800', color: '#6c3ce0', letterSpacing: 2 },
  pie: { textAlign: 'center', fontSize: 12, color: '#7a6f96', marginTop: 6 },
  boton: {
    marginTop: 24,
